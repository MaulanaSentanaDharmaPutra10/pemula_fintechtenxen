        ...
        <table class="table  bg-white">
            ...
            <tbody>
                ...
                <td class="flex gap-2" rowspan="{{ count($transaction) }}">
                    <a href="{{ route('admin.transaction.print',['date' => $date,'user_id' => $per_transaction->user->id] )}}" class="btn bg-blue-600 text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
