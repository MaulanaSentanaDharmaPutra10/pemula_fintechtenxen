...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-xl font-semibold">Topup Baru</h1>
    <a href="{{ route('bank.topup.index') }}" class="btn bg-gray-300 btn-md">Kembali</a>
</div>
<div class="w-full bg-white p-8 rounded-md mt-8 mb-8">
    <form action="{{ route('bank.topup.post') }}" method="POST" class="flex flex-col gap-4 w-full" enctype="multipart/form-data">
        @csrf
