...
Route::prefix('/bank')->group(function () {
    ...
    Route::get('/transaction/printtariktunais/{date}', [BankController::class,'printtariktunais'])->name('bank.transaction.printtariktunais');
   });
});
...
Route::prefix('/kantin')->group(function () {
    Route::middleware(['kantin'])->group(function () {
        ...
        Route::get('/confirm', [KantinController::class, 'confirm'])->name('kantin.confirm');
        Route::put('/confirm/product/{id}', [KantinController::class, 'confirmProduct'])->name('confirm.product');
    });
});
